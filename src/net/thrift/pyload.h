...
class PyloadIf {
 public:
  ...
  virtual void parseURLs(std::map<PluginName, LinkList> & _return, const std::string& html, const std::string& url) = 0;
  ...
  virtual void getEvents(std::vector<EventInfo> & _return, const std::string& uuid) = 0;
...
class PyloadNull : virtual public PyloadIf {
 public:
  ...
  void parseURLs(std::map<PluginName, LinkList> & /* _return */, const std::string& /* html */, const std::string& /* url */) {
    return;
  }
  ...
  void getEvents(std::vector<EventInfo> & /* _return */, const std::string& /* uuid */) {
    return;
  }
...
typedef struct _Pyload_parseURLs_args__isset {
  _Pyload_parseURLs_args__isset() : html(false), url(false) {}
  bool html;
  bool url;
...
class Pyload_parseURLs_args {
 public:
  ...
  Pyload_parseURLs_args() : html(""), url("") {
  }
...
class Pyload_getEvents_result {
 public:
  ...
  std::vector<EventInfo>  success;

  _Pyload_getEvents_result__isset __isset;

  void __set_success(const std::vector<EventInfo> & val) {
    success = val;
  }
...
class PyloadClient : virtual public PyloadIf {
 public:
  ...
  void parseURLs(std::map<PluginName, LinkList> & _return, const std::string& html, const std::string& url);
  void send_parseURLs(const std::string& html, const std::string& url);
  ...
  void recv_getEvents(std::vector<EventInfo> & _return);
  void getAccounts(std::vector<AccountInfo> & _return, const bool refresh);
...
class PyloadMultiface : virtual public PyloadIf {
 ...
 public:
  ...
  void parseURLs(std::map<PluginName, LinkList> & _return, const std::string& html, const std::string& url) {
    ...
    for (size_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->parseURLs(_return, html, url);
        return;
      } else {
        ifaces_[i]->parseURLs(_return, html, url);
      }
